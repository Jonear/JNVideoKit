...
//    {
//        filterSourceTexture = [firstInputFramebuffer texture];
//    }
//    else if (filterSourceTexture2 == 0)
//    {
//        filterSourceTexture2 = [firstInputFramebuffer texture];
//    }
//    else if (filterSourceTexture3 == 0) {
//        filterSourceTexture3 = [firstInputFramebuffer texture];
//    }
//    else if (filterSourceTexture4 == 0) {
//        filterSourceTexture4 = [firstInputFramebuffer texture];
//    }
//    else if (filterSourceTexture5 == 0) {
//        filterSourceTexture5 = [firstInputFramebuffer texture];
//    }
//    else if (filterSourceTexture6 == 0) {
//        filterSourceTexture6 = [firstInputFramebuffer texture];
//    }
//}
...
//    if (filterSourceTexture == 0)
//    {
//        filterSourceTexture = [newInputFramebuffer texture];
//    }
//    else if (filterSourceTexture2 == 0)
//    {
//        filterSourceTexture2 = [newInputFramebuffer texture];
//    }
//    else if (filterSourceTexture3 == 0) {
//        filterSourceTexture3 = [newInputFramebuffer texture];
//    }
//    else if (filterSourceTexture4 == 0) {
//        filterSourceTexture4 = [newInputFramebuffer texture];
//    }
//    else if (filterSourceTexture5 == 0) {
//        filterSourceTexture5 = [newInputFramebuffer texture];
//    }
//    else if (filterSourceTexture6 == 0) {
//        filterSourceTexture6 = [newInputFramebuffer texture];
//    }
//}
